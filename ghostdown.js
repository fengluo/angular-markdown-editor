...
CodeMirror.defineMIME("text/x-markdown", "markdown");
    ...
    angular.module('ghostdown', [])
    .directive('ghostMarkdown', [function(){
        function link(scope, element, attrs){
            var textarea = document.querySelector('textarea');
            var preview = document.querySelector('.rendered-markdown');
            ...
            // document.querySelector('.CodeMirror-scroll').onscroll = function(){
            //     if (document.querySelector('.CodeMirror-scroll').scrollTop > 10) {
            //         document.querySelector('.entry-markdown').classList.add('scrolling');
            //     }else{
            //         document.querySelector('.entry-markdown').classList.remove('scrolling');
            //     }
            // }         
        }
        return {
